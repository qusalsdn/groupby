...
export default function SignIn() {
  ...
  return (
    <div>
      {!loading && (
        <div>
          <FontAwesomeIcon icon={faArrowRightToBracket} className="text-center w-full text-lg mb-3" />
          <p className="text-center font-bold text-2xl">로그인</p>
